                ...
                <div className="lg:p-12 advantage-para lg:pl-20 lg:pr-20 lg:m-0 m-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between">
                        <div className="container">
                            <ul className={`team-list grid grid-cols-1 gap-4 lg:gap-0 ${grid ?? 'lg:grid-cols-4'}`}>
                                {points?.map((ele) => (
                                    <>
                                        <li className={`bg-customer hover:scale-105 m-1 lg:p-8 text-center flex items-center justify-center ${ width ?? 'lg:w-[250px]'} h-[150px] w-auto`}>
                                            {ele}
                                        </li>
                                    </>
                                ))}
