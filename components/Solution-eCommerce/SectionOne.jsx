      ...
      <section className={`grid lg:grid-cols-2 grid-cols-1 gap-x-0`}>
        <section>
          <section className="ml-4 lg:ml-0 relative z-20">
            <h1 className="text-3xl lg:text-[2.972rem] stroke-text-ecommerce MonumentBold uppercase leading-[1.3] mt-4 lg:!w-[800px]">
        ...
        <section className="pt-0 pl-12 ed-tech-dropshadow relative z-10 right-0 hidden lg:block">
          <Image
            ...
            className={`rounded-2xl w-[54%] ed-tech-dropshadow absolute -right-8 bottom-0`}
            fetchPriority="high"
            width={1900}
            height={1900}
          />
