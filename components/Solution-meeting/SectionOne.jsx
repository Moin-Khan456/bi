      ...
      <section className={`grid lg:grid-cols-2 grid-cols-1 gap-x-0 container`}>
        <section className="container padding-left-all-section-1 relative">
          <section className="ml-4 lg:ml-0 relative z-20">
            <h1 className="text-[2.96875rem] MonumentRegular leading-[4rem] mt-4 lg:!w-[900px]">
            ...
            Experience the elegance of simplicity with Brain Inventory&apos;s Meeting & Event Management Solution, your one-stop software for comprehensive scheduling, planning, and executing fruitful events with utter finesse.
            </h6>
          </section>
          <Link href="#talk">
