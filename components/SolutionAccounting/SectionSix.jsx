...
const Index = ({title, btn, head, src, headAbove, subheadAbove, customClasses, classText, titleClass}) => {
    ...
    return (
        <div className="padding-left-all-section-1 rounded-md my-8 py-10 px-4">
            ...
            <p className="text-slate-400 py-4">{subheadAbove}</p>
                <div className='lg:grid lg:grid-cols-2 gap-0 h-auto bg-[#4601a1] rounded-3xl relative section-six-card'>
                      <div className='p-12'>
                          <h1 className={`font-bold lg:text-3xl MonumentRegular ${titleClass} ${classText}`}>{title}</h1>
