      ...
      <div className="container padding-left-all-section">
        <div className="lg:grid lg:grid-cols-2 gap-6">
          <div className="p-6 lg:p-0">
            ...
            <h1 className="font-bold lg:text-7xl lg:leading-[70px] lg:w-[400px] text-[#F7D927] monument">
              {head}
            </h1>
            <h3 className="font-bold text-lg mb-6 monument">{subhead}</h3>
          ...
          <div>
            <Image
              src="https://d1u4arv5y5eda6.cloudfront.net/images/solution/abstract-yellow-rocket-ship-concept-cartoon-style.png"
              width={800}
              height={500}
              alt=""
              className="w-[800px]"
