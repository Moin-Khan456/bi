...
const SectionThree = () => {
  return (
    <div className="container py-12">
      <h1 className="text-3xl">Fitness Industry Insights</h1>
      ...
      <div className="bg-[#121212] p-8">
        ...
        <p className="font-Satoshi font-semibold text-sm text-slate-500">
      ...
      <div className="bg-[#121212] p-8 my-6">
        ...
        <table className="w-full my-12">
          <thead className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
            <tr className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
              <th className="border border-1 font-Satoshi font-bold py-4 border-slate-300 text-left px-4 w-[66%]">Statistic</th>
              <th className="border border-1 font-Satoshi font-bold py-4 border-slate-300 text-left px-4">Source</th>
            </tr>
          </thead>
          <tbody className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
            <tr className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">Over 75% of people use health and fitness solutions more than once a week.</td>
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">Flurry Analytics</td>
            </tr>
            <tr className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">Health and fitness solutions usage grew by over 330% in just three years.</td>
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">Flurry Analytics</td>
            </tr>
            <tr className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">59% of users say that they are more active due to their use of fitness solutions.</td>
              <td className="border border-1 font-Satoshi font-semibold py-4 border-slate-300 px-4">Flurry Analytics</td>
            </tr>
          </tbody>
        </table>
