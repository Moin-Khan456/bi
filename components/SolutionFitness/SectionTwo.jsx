  ...
  return (
    <div className={`${className}`}>
      ...
      <div className="flex lg:items-end flex-col md:flex-col lg:flex-row py-8 relative">
          <h1 className="px-4 text-3xl md:text-5xl lg:text-8xl monument w-full lg:w-[45%] lg:max-w-auto uppercase ">{title} <span className="px-4 pb-3 text-[1.7rem] lg:ml-52 whitespace-nowrap absolute bottom-10 left-[30rem] Gilroy-SemiBold ">Development Company</span></h1>
        </div>
