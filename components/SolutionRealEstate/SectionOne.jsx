  ...
  return (
    <main className="relative bg-no-repeat bg-center bg-cover  bg-[url('https://braininventory.s3.us-east-2.amazonaws.com/images/realState_banner.webp')]">
      <div className="flex flex-col justify-center h-screen padding-left-all-section-1 ">
        ...
        <div className="flex flex-col items-center text-primaryBg">
          ...
          <Link href="#talk">
            <button className="w-fit flex items-center justify-center lg:justify-start font-Satoshi font-bold text-xs rounded-full bg-primaryTx px-6 py-4 my-12">
