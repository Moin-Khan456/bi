    ...
    <div className={`${className} padding-left-all-section-1`}>
      <div className="container">
        <div className="flex lg:items-end flex-col md:flex-col lg:flex-row py-8 relative">
          <h1
            className={`px-4 ${titleSize ?? 'lg:text-[4rem]'} text-4xl  ${classText} monument grid grid-cols-1 lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 items-end w-auto lg:max-w-auto uppercase lg:leading-[4rem]`}
          >
            TOP <br/> Real Estate <br/> SOFTWARE
            <span
