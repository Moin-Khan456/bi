      ...
      <div className="container">
        <div className="flex lg:items-end flex-col md:flex-col lg:flex-row py-8 relative">
          <h1
            ...
            } text-4xl  ${classText}  monument grid grid-cols-1 lg:grid-cols-2 grid-rows-1 lg:grid-rows-1 items-end w-auto lg:max-w-auto uppercase lg:leading-[6.5rem]`}
          >
            Efficient Real Estate Software Development Services by Brain
            Inventory
            {isHeadShow ? (
              <span
