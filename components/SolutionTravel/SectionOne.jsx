  ...
  return (
    <main className="relative bg-no-repeat bg-center bg-cover bg-[url('https://braininventory.s3.us-east-2.amazonaws.com/images/solution/travel/Group+7198.png')]">
      <div className="flex flex-col justify-center h-screen px-12 ">
        <h1 className="MonumentRegular text-4xl lg:text-[3.75rem] lg:leading-[4rem] w-1/2 pt-16">Your Gateway to Global Adventures</h1>
        <p className="w-1/2 text-xs pt-8">Welcome to Brain Inventory, Your gateway to the world of bespoke travel software! Explore, Innovate, and Transform your travel business with our cutting-edge technology services.</p>
