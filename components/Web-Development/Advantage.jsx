...
export default function Advantage({ title, para1, para2, para3, para4, para5, para6 }) {
    return (
        <div className="container padding-left-all-section-1">
            <h1 className='text-4xl lg:text-5xl Gilroy-Bold w-fit px-2'>Benefits of <span className='text-[#7600EB]'>PHP Development</span></h1>
