            ...
            <section className="grid lg:grid-cols-2 grid-cols-1 gap-6">
                <section className="">
                    <section className="ml-4 lg:ml-0 flex flex-col items-center lg:items-start">
                        ...
                        {/* <Image src="https://braininventory.s3.us-east-2.amazonaws.com/images/Technology/Group 6439.png" alt="Development" width={300} height={100} className="w-8/12 lg:-my-10 lg:-ml-8" /> */}
