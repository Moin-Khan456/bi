...
export const CareerHeroSection = {
  heading: "Lets do some great things together!",
  title: "Apply for Full Time Job",
  content: `While we are good at sign language, there are various other
                simpler ways to connect with us.Talk to us in person.`,
  image: "bg-careerImg",
};
export const whyWorkDataCareer = {
  title:"Why work with Brain Inventory?",
  content:[` When you join Brain Inventory, you join a thriving company and
            ...
            people where you can be your best self.`,`Life at Brain Inventory is brimming with a dynamic and fun
...
export const careerCategories = {
  title:"Work culture at its best",
  description:"",
  content:
  [
