                    ...
                    <div>
                        ...
                        <div className="flex flex-col lg:flex-row w-full">
                            <div className="bg-technology p-10 lg:ml-8 mb-4 flex flex-col items-center">
                                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6156.svg" alt={alt} width={40} height={40}/>
                            ...
                            <div className="bg-technology p-10 lg:ml-8 mb-4 flex flex-col items-center">
                                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6157.svg"  alt={alt} width={40} height={40}/>
                                <p className="Gilroy-Light text-lg opacity-60 pt-4">
                            ...
                            <div className="bg-technology p-10 lg:ml-8 mb-4 flex flex-col items-center">
                                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6158.svg"  alt={alt} width={40} height={40}/>
                                <p className="Gilroy-Light text-lg opacity-60 pt-4">
