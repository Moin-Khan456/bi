...
export default function ChooseBraininventory({head, blue, alt}) {
    return (
        ...
        sizes="(max-width: 320px) 280px,
             ...
             800px" src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6156.svg" alt={alt} width={40} height={40}/>
        ...
        sizes="(max-width: 320px) 280px,
             (max-width: 480px) 440px,
             800px" src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6157.svg"  alt={alt} width={40} height={40}/>
                                <p className="Gilroy-Light text-lg opacity-60 pt-4">
        ...
        sizes="(max-width: 320px) 280px,
             (max-width: 480px) 440px,
             800px" src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group 6158.svg"  alt={alt} width={40} height={40}/>
                                <p className="Gilroy-Light text-lg opacity-60 pt-4">
