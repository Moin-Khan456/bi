            ...
            <h1 className="Gilroy-Bold lg:text-6xl text-[1.9rem] lg:leading-[4.5rem]">
              {titleArray.map((ele, index) => (
                <span className='' key={index}>
                  {ele.includes("Brain") ? <span className='text-[#7600EB]'>{ele}</span>:<span>{ele}</span>}
                </span>
              ))}
            </h1>
            <p className="text-lg font-thin opacity-60 lg:mt-4 hidden lg:block">{subhead}</p>
            <p className="text-lg font-thin opacity-60 lg:mt-4 hidden lg:block">{subhead1}</p>
            <p className="text-lg font-thin opacity-60 lg:mt-4 hidden lg:block">{subhead2}</p>
          </section>
        </section>
