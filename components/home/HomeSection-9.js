        ...
        <div className="w-full">
          <div className="">
            ...
            <div className="overflow-x-hidden relative bottom-24">
              <Image  
          width={1833} height={1425} loading="lazy" src="https://braininventory.s3.us-east-2.amazonaws.com/images/groupImage.png" alt="custom software development solutions" />
