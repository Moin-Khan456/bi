...
const MyComponent = () => {
    const projects = [
        ...
        { title: "Ocureel", subtitle: "UI/UX Design, Custom Software Development.", src: "https://braininventory.s3.us-east-2.amazonaws.com/videos/ocureel.mp4", poster: "https://braininventory.s3.us-east-2.amazonaws.com/images/project/Screenshot -2.png", link: "/project/ocureel" },
    ]
    return (
