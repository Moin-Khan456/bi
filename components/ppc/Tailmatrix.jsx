    ...
    <div className='container'>
        <div className="max-w-full flex flex-col lg:flex-row justify-around m-4 lg:m-32">
            <div className="lg:w-1/2 text-white text-center lg:text-start">
                <h1 className='text-3xl lg:text-5xl Satoshi font-semibold lg:font-bold lg:w-[70%]'>Custom social network software we built are used by millions across the world</h1>
                <p className='text-slate-400 Gilroy-Bold my-8 lg:w-[60%]'>Applications that are designed and developed to handle large userbase from different countries</p>
            </div>
