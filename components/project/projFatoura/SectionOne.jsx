...
const Index = ({ section }) => {
    return (
        <div className="max-w-full lg:min-h-screen flex flex-col px-4 lg:px-12">
            <Image  
          width={600} height={600} src={section.logo} className="lg:w-1/6 py-12" alt="Fatoura" />
          ...
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/project/XD.png" width={500} height={500} className="w-[10%] lg:w-[20%]" alt="Accounting Based Software Development Company"/></span>
            </div>
