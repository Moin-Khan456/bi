    ...
    return (
        <div className="relative flex flex-col lg:flex-row items-end justify-center bg-white max-w-full">
            <div className="bg-[#e8fdd0] lg:h-screen lg:w-[60%]">
                ...
                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/ocureel/Group+6399.png" width={1000} height={1000} alt="" className='lg:w-[80%]'/>
            </div>
            <div className="bg-[#e2e1fe] w-full lg:w-[40%] lg:h-[70vh]">
                ...
                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/ocureel/Group+6400.png" width={1000} height={1000} alt="" className=''/>
            </div>
