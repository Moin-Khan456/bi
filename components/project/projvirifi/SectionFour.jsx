    ...
    return (
        <div className="container py-8 relative flex flex-col justify-center ">
            ...
            <div className="px-4 lg:px-48 lg:py-12">
                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/project/virifi/Mask+Group+275.png" width={900} height={600} alt="Custom Software Development Company | Application Development Company"  className='m-auto block'/>
            </div>
        </div> 
    )
}
