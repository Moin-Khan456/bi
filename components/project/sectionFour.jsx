    ...
    return (
        <div className="pt-12 pb-0 my-8 relative flex flex-col justify-center">
            <div className="flex items-center">
                ...
                <Image  
          src="https://braininventory.s3.us-east-2.amazonaws.com/images/Group+6424.png" alt="Custom Software Development Company | Application Development Company" width={700} height={700} className='w-28 lg:w-52' />
            </div>
            <div className="py-4">
