  ...
  return (
    <div className="container">
      ...
      <div className="flex justify-center items-center flex-col lg:flex-row w-full">
        <div className="max-w-full lg:w-[50%] h-auto mx-4 bg-primaryTx rounded-3xl my-4 pt-4 px-8 project__three__one">
          <div className="">
            <div className="">
              <h3 className="text-primaryBg">Dashboard</h3>
              <Image
            ...
            <div className="">
              <h3 className="text-primaryBg">Settings</h3>
              <Image
        ...
        <div className="max-w-full lg:w-[50%]">
          <div className="lg:px-12 bg-secondaryBg mb-12 rounded-2xl mx-4 project__three__two h-[50%]">
            <h3 className="text-secondaryTx text-lg lg:text-2xl pt-4  Gilroy-Bold pl-8">
          ...
          <div className="px-4 lg:px-24 bg-secondaryBg mt-12 rounded-2xl mx-4 project__three__two h-[50%]">
            <h3 className="text-secondaryTx text-lg ml-4 lg:ml-0 lg:text-2xl pt-4 Gilroy-Bold">
              User Management
            </h3>
            <Image
