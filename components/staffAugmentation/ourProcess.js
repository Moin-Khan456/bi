    ...
    <div className="2xl:p-10 p-8 2xl:space-y-8 space-y-6">
      <div className="container padding-left-all-section-1">
        ...
        <h2 className="text-4xl Gilroy-Bold">
          Quick and Transparent Process to the Hire <br /> Remote Developers
        </h2>
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
          <div className="class-inventory after-one">
            <h4 className="text-xl leading-8 Gilroy-Bold text-primaryBg">
              Brain Inventory Shortlists the Best Candidates (8 hours)
            </h4>
            <ul className="pt-6 ml-4">
              <li className="text-primaryBg text-lg mb-1 list-disc">
          ...
          <div className="class-inventory after-3">
            <h4 className="text-xl leading-8 Gilroy-Bold text-primaryBg">
              1st Round of Interview is <br /> Conducted (8 hours)
            </h4>
            <ul className="pt-6 ml-4">
              <li className="text-primaryBg text-lg mb-1 list-disc">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
          <div className="class-inventory after-four">
            <h4 className="text-xl  text-primaryBg leading-8 Gilroy-Bold">
              Requirements Gathering (3.5 hours)
            </h4>
            <ul className="pt-6 ml-4 text-primaryBg">
              <li className=" text-lg mb-1 list-disc">
          ...
          <div className="class-inventory after-5 ">
            ...
            <ul className="pt-6 ml-4 text-primaryBg">
              <li className=" text-lg mb-1 list-disc">
                Availability schedule for 1 day is shared by client for
                interview
              </li>
              <li className="text-lg mb-1 list-disc">
