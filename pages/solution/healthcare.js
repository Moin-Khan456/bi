...
function ReactNativeDeveloper(props) {
  ...
  const sectionFiveTable = [
    ...
    ["Over 5 million", "More than 2 million", "Over 28 million active users", "More than 200 million"],
  ];
  ...
  const setionThreeCards = [
    {
      ...
      content: "Healthcare has always been a pivotal sector, but recent years have seen an unprecedented surge in its digitization. With the advent of web and mobile applications, the healthcare sector is witnessing a transformative phase. Here are some stats to back up this trend:",
      points: [
    ...
    },
    {
      ...
      content: "The digital age has given rise to a new era in healthcare—an era where patients have access to health information at their fingertips, and healthcare providers have the technology to provide faster and more efficient care. The role of online platforms in healthcare is becoming increasingly crucial, as these statistics demonstrate:",
      tableHead: ["Static", "Source"],
      tableContent: [["77% of patients use search engines before booking appointments", "Think With Google"], ["Almost 60% of all healthcare visits were done virtually in 2020", "Forrester"], ["80% of internet users have searched for a health-related topic online", "Pew Internet & American Life Project"]]
    }
  ]
  ...
  return (
    <>
      <Head>
        <title>
          Healthcare App Development Solution | Healthcare App Development Services
        </title>
        <link
          rel="canonical"
      ...
      <main className="">
        ...
        <section className="">
          ...
          />
          <SectionThree title="Healthcare Industry Insights" sectionDesc="Healthcare is a rapidly evolving industry that is increasingly becoming technologically driven. Here are some captivating insights about the healthcare industry:" setionThreeCards={setionThreeCards}/>
          ...
          <PlatformDevelopment cardPoints={platformDevelopment} subhead="WHY CHOOSE BRAIN INVENTORY FOR" head="HEALTHCARE SOLUTION DEVELOPMENT" description={platformDesc}/>
          <SectionNine brand="HEALTHCARE SOLUTION DEVELOPMENT       " pageCategory="HEALTHCARE SOLUTION DEVELOPMENT    " pageCategoryAbbr="HEALTHCARE SOLUTION DEVELOPMENT      " slow={70000} fast={55000} src="https://d1u4arv5y5eda6.cloudfront.net/images/solution/healthcare/jared-rice-NTyBbu66_SI-unsplash.png"/>
          <PlatformDevelopment cardPoints={keyFeatures} subhead="KEY FEATURES OF" head="HEALTHCARE SOLUTION DEVELOPMENT" description={keyDesc}/>
          <Approach title="How do we Approach Healthcare Solution Development?" desc={approachDesc} points={approachPoints}/>
          <SectionTen/>
